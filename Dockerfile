...
# Magic happens
RUN apt-get install -y google-chrome-stable=72.0.3626.81
...
RUN wget -O /tmp/chromedriver.zip https://chromedriver.storage.googleapis.com/LATEST_RELEASE_72.0.3626/chromedriver_linux64.zip
